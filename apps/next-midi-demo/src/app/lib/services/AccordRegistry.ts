...
export class AccordRegistry
  extends Effect.Service<AccordRegistry>()('next-midi-demo/AccordRegistry', {
    ...
    scoped: Effect.gen(function* () {
      const currentAccordIndexRef = yield* SubscriptionRef.make(AccordIndex(0))
      ...
      return {
        ...
        selectAccord: (accordIndex: AccordIndex) =>
...
interface IAccordRegistry {
  ...
  readonly selectAccord: (accordIndex: AccordIndex) => Effect.Effect<void>
}
