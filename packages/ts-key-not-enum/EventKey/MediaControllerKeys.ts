 ...
 *   the basic controls covered elsewhere in this document, key values are
 *   defined for a broad array of these additional buttons.
 *
 ...
 *       Protocol and Framework for Remote User Interface on UPnP™ Networks and
 *       the Internet.
