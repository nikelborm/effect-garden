...
export const parse = (data: unknown): Effect.Effect<SongFull, ParseError> =>
  checkType(
    'SongFull',
    {
      type: 'SONG',
...
export const parseSearchResult = (
  item: unknown,
): Effect.Effect<SongDetailed, ParseError> => {
...
export const parseHomeSection = (
  item: unknown,
): Effect.Effect<SongDetailed, ParseError> => parseSearchResult(item)
